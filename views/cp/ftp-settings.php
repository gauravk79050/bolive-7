			...
			<div class="table">
                ...
                <form method="post" action="">
			       ...
			       <tbody>
                         ...
                         <td><input type="text" class="text medium" name="obs_shop" id="obs_shop" value="<?php echo @$company->obs_shop; ?>" style="width: 500px; height: 25px;" />
                             <br />
				      ...
				      <tr>
                         ...
                         <td><input type="text" class="text medium"  name="shop_url" id="shop_url" value="<?php echo @$company->shop_url; ?>" style="width: 500px; height: 25px;" />
                             <br />
                      ...
                      <tr>
                         ...
                         <td><input type="text" class="text medium" name="shop_files_loc" id="shop_files_loc" value="<?php echo @$company->shop_files_loc; ?>" style="width: 500px; height: 25px;" />
                             <br />
                      ...
                      <tr>
                         ...
                         <td><input type="text" class="text medium" name="ftp_hostname" id="ftp_hostname" value="<?php echo @$company->ftp_hostname; ?>" style="height: 25px;" /></td>
                      </tr>
                      <tr>
                         <td><?php echo _('FTP Username'); ?> :</td>
                         <td><input type="text" class="text medium" name="ftp_username" id="ftp_username" value="<?php echo @$company->ftp_username; ?>" style="height: 25px;" /></td>
                      </tr>
                      <tr>
                         <td><?php echo _('FTP Password'); ?> :</td>
                         <td><input type="text" class="text medium" name="ftp_password" id="ftp_password" value="<?php echo @$company->ftp_password; ?>" style="height: 25px;" /></td>
                      </tr>                      
                      <tr>
