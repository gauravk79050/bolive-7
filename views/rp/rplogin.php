        ...
        <td align="center"><table width="430" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="302" valign="top" bgcolor="#8992AD" style="padding-left:5px">
			   <?php echo form_open( base_url()."rp/rplogin/",array('name'=>"frm_login",'id'=>"frm_login",'method'=>"post"));?>
                ...
                <table width="293" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="215" align="left"><?php echo form_input(array('name'=>"p_username",'id'=>"p_username",'class'=>"textbox"));?></td>
                  </tr>
                  <tr>
                    <td height="24" align="left" class="whiteSmallBold"><?php echo _('Password')?></td>
                    <td align="left"><?php echo form_password(array('name'=>"p_password",'id'=>"p_password",'class'=>"textbox"));?></td>
                  </tr>
                  <tr>
				...
				<script type="text/javascript">
					...
					frmvalidator.addValidation("p_username","req","<?php echo _('Please enter your login Username');?>");
					frmvalidator.addValidation("p_password","req","<?php echo _('Please enter your login Password');?>");
				</script>             
              </td>
            </tr>
          </table></td>
