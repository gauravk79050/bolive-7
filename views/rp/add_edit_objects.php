            ...
            <tbody>
              <tr>
                <td valign="middle" align="center" style="border:#8F8F8F 1px solid;">
				          <?php
                  echo form_open_multipart("rp/autocontrole/updateObjects",array('method'=>"post" ,'id'=>"frm_autocontrole_objects_addedit", 'name'=>"frm_autocontrole_objects_addedit"));
                  ?>
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      <tr>
                            ...
                            <tbody class="reverse_data_obj">
                              <tr>
                                  ...
                                  <td width="40%" align="left">
                                    <a target="_blank" href="<?php echo base_url(); ?>rp/autocontrole/object_categories">
                                  ...
                                  <td width="3%" align="left">
                                    <div class="icon_button" style="height: 17px !important;width: 17px !important;">
                                      <a title="Go Back" href="<?php echo base_url('rp/autocontrole/objects'); ?>"><img src="<?php echo base_url();?>assets/mcp/images/undo.jpg" alt="Go Back"></a>
                                    </div>
                                  </td>
                              </tr>
                            </tbody>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td height="30">
                                  ...
                                  <td>
                                  <?php echo _( "Dutch" ) ?>:
                                  <input type="text" class="textbox" name="object_name_dch" id="object_name_dch" required="required" placeholder="Dutch" value="<?php echo $object_name_dch; ?>">
                                </td>
                                <td>
                                  <?php echo _( "French" ) ?>:
                                ...
                                <td>
                                  ...
                                  <a href="<?php echo base_url('rp/autocontrole/editObjects/'.$prev_n_nxt_id['prev_id']); ?>"><img src="<?php echo base_url(); ?>assets/images/left-arrow.png" title="Previous" alt="Previous"></a>
                                  <?php }
                                  if(isset($prev_n_nxt_id['next_id']) && $prev_n_nxt_id['next_id']!='' ) { ?>
                                  <a href="<?php echo base_url('rp/autocontrole/editObjects/'.$prev_n_nxt_id['next_id']); ?>"><img src="<?php echo base_url(); ?>assets/images/right-arrow.png" title="Next" alt="Next"></a>
                                  <?php } ?>
                                </td>
                              ...
                              <tr>
                               ...
                               <tr>
                                ...
                                <td>
                                  <select  class="textbox" name="group_id" required>
                              ...
                              <tr>
                               ...
                               <tr>
                                ...
                                <td>
                                  <select class="select_autocontrole_type textbox" name="related_type_ids[]" multiple="" required>
                                   <?php 
...
<script type="text/javascript">
  $( document ).on( 'click' , '.select_autocontrole_type option' , function( ){
   ...
   var $this               = $( this );
   $.ajax({
        url: base_url + 'rp/autocontrole/get_related_predifineds',
        data : {
