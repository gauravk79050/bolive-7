                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td width="30%" align="right">
                                      ...
                                      <div style="background-image:url(<?php echo base_url();?>assets/mcp/images/add.png);float:right;" title="Add Category" class="icon_button" onClick="window.location.href='<?php echo base_url(); ?>rp/autocontrole/addedit_objects_category'" id="btn_add"></div>
                                    </td>
                                  </tr>
                                </tbody>
                            </table>
                                                  ...
                                                  <tr data-id="<?php echo $cat[ 'id' ]; ?>" class="proc_row">
                                                    ...
                                                    <td width="20%" class="whiteSmallBold" bgcolor="#FFFFFF"  >
                                                      <span class="blackMediumNormal">
                                                          <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>rp/autocontrole/addedit_objects_category/<?php echo $cat[ 'id' ]; ?>'" style="cursor:pointer">
