            ...
            <tbody>
              <tr>
                <td valign="middle" align="center" style="border:#8F8F8F 1px solid;">
                  ...
                  echo form_open_multipart("rp/autocontrole/".$url."",array('method'=>"post" ,'id'=>"frm_autocontrole_predifined_addedit", 'name'=>"frm_autocontrole_type_addedit"));
                  if( !empty( $predif ) ){ ?>
                              ...
                              <tr>
                                  ...
                                  <td width="3%" align="left">
                                    <div class="icon_button">
                                       <a title="Go Back" href="<?php echo base_url('rp/autocontrole/predifined'); ?>"><img src="<?php echo base_url();?>assets/mcp/images/undo.jpg" alt="Go Back"></a>
                                    </div>
                                  </td>
                              </tr>
                            </tbody>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="text-align: right;">
                                  ...
                                  <a href="<?php echo base_url('rp/autocontrole/addeditPredifined/'.$prev_n_nxt_id['prev_id']); ?>"><img src="<?php echo base_url(); ?>assets/images/left-arrow.png" title="Previous" alt="Previous"></a>
                                  <?php }
                                  if(isset($prev_n_nxt_id['next_id']) && $prev_n_nxt_id['next_id']!='' ) { ?>
                                  <a href="<?php echo base_url('rp/autocontrole/addeditPredifined/'.$prev_n_nxt_id['next_id']); ?>"><img src="<?php echo base_url(); ?>assets/images/right-arrow.png" title="Next" alt="Next"></a>
                                  <?php } ?>
                                </td>
