<html>
	...
	<body>
		<?php echo _('A new order has been placed on your shop.'); ?>
		<br /><br />
		...
		<?php /*?> <table width="100%" cellspacing="2" cellpadding="2" border="0">
  			<tr>
    			<td>
          					...
          					<td width="100%" valign="top" colspan="2">
          						<table width="100%" border="0" cellspacing="0" cellpadding="2">
              						<tr>
                						...
                						<td bgcolor="#F0F0F0"><b><?php echo _("Delivery Address");?>:</b></td>
              						</tr>
              						<tr>
                						<td>
                							<strong>
              						...
              						<tr>
              							<td>
              								<strong>
												...
												<?php echo _("Email")?> :&nbsp;<?php echo $client->email_c;?><br /><br/>
											</strong>
              							</td>
              						</tr>
								</table>
    			...
    			<td>
    				<table border="0" cellpadding="2" cellspacing="2" width="100%">
        				<tr>
							...
							<td width="15%" align="left" bgcolor="#EAEAEA"><strong>Tarief</strong></td>
							<?php //} ?>
							
		  					<td width="35%" align="left" bgcolor="#EAEAEA"><strong><?php echo _("Extra");?></strong></td>
		  					
							<?php //if($products_pirceshow_status == '0'){ ?>
							<td width="8%" align="left" bgcolor="#EAEAEA"><strong>Totaal</strong></td>
							<?php //}?>
        				</tr>
