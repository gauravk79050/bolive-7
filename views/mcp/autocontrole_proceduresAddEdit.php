            ...
            <tbody>
              <tr>
                <td valign="middle" align="center" style="border:#8F8F8F 1px solid;">
                  ...
                  echo form_open_multipart("mcp/autocontrole/".$url."",array('method'=>"post" ,'id'=>"frm_autocontrole_Procedure_addedit", 'name'=>"frm_autocontrole_type_addedit")); 
                  if( !empty( $procedure ) ){ ?>
                      ...
                      <tr>
                        <td align="center" style="padding:15px 0px 10px 0px">
                          <table width="98%" cellspacing="0" cellpadding="0" border="0" style="background:url(images/bg.jpg) left top repeat-x;" class="page_caption">
                            <tbody>
                              <tr>
                                <td width="94%" align="left"><h3><?php echo _('Add Procedure'); ?>&nbsp;</h3><h3><a target="_blank" style="color:blue;" class="category_mng" href="<?php echo base_url(); ?>mcp/autocontrole/category"><?php echo _('Category managment'); ?></a></h3></td>
