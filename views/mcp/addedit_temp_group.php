            ...
            <tbody>
              <tr>
                <td valign="middle" align="center" style="border:#8F8F8F 1px solid;">
				          <?php  
                  echo form_open_multipart("mcp/autocontrole/update_temp_group",array('method'=>"post" )); 
                      ...
                      <tr>
                        <td align="center" style="padding:15px 0px 10px 0px">
                          <table width="98%" cellspacing="0" cellpadding="0" border="0" style="background:url(images/bg.jpg) left top repeat-x;" class="page_caption">
                            <tbody>
                              <tr>
                                  <td width="94%" align="left"><h3> <?php echo _('Temperature Group'); ?></h3></td>
                      ...
                      <tr>
                        <td align="center" style="padding-bottom:15px">
                          <table width="98%" cellspacing="0" cellpadding="5" border="0" align="center" style="border:1px solid #003366; text-align:left;">
                            <tbody>
                              <tr>
                                <td height="20" bgcolor="#003366" align="left" style="padding-left:10px;" class="whiteSmallBold" colspan="4"><?php echo _('Add Temperature Group'); ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <?php 
                                  ...
                                  $max_temp             = '';
                                  if( isset( $temp_group ) ){
                                    $temp_group_name      = $temp_group[ 'temp_group_name' ]; 
                                    $temp_group_name_fr   = $temp_group[ 'temp_group_name_fr' ]; 
                                    $temp_group_name_dch  = $temp_group[ 'temp_group_name_dch' ]; 
                                ...
                                ?>
                                  ...
                                  <?php echo _( 'Dutch' ) ?>:
                                  <?php echo form_input(array('type'=>"text",'style'=>"width:140px", 'class'=>"textbox",'id'=>"type_name_dch",'name'=>"temp_group_name_dch", 'placeholder'=>"DU",'required'=> 'required', 'value' => $temp_group_name_dch ,'title'=> 'Dutch') );?>
                                </td>
                                <td width="20%" height="31" style="padding-left:10px;">
                                  <?php echo _( 'French' ) ?>:
                                  <?php echo form_input(array('type'=>"text",'style'=>"width:140px", 'class'=>"textbox",'id'=>"type_name_fr",'name'=>"temp_group_name_fr", 'placeholder'=>"FR",'required'=> 'required', 'value' => $temp_group_name_fr ,'title'=>"French") );?>
                                </td>
                                <td width="20%" height="31" style="padding-left:10px;">
                                  <?php echo _( 'English' ) ?>:
                                    <?php echo form_input(array('type'=>"text",'style'=>"width:140px", 'class'=>"textbox",'id'=>"type_name",'name'=>"temp_group_name", 'placeholder'=>"EN" ,'required'=> 'required' , 'value' => $temp_group_name ,'title'=>'English') );?>
                                </td>
                              </tr>
                              <tr>
                                            ...
                                            <tbody>
                                              <tr>
                                               ...
                                               <td width="47%" height="31" style="padding-left:10px;">
                                                  ...
                                                  <?php echo form_input(array('type'=>"text", 'class'=>"textbox",'id'=>"ideal_temp",'name'=>"ideal_temp",'required'=> 'required' , 'value' =>  $symbol.defined_money_format( $ideal_temp , $precision ) ) );?>
                                              </td>
                                                </tr>
                                              </tbody>
                                          </table>
                                              ...
                                              <tr>
                                                ...
                                                <td width="1%" height="31" style="padding-left:10px;">
                                                   <?php 
                                                    ...
                                                    <?php echo form_input(array('type'=>"text",'class'=>"textbox",'id'=>"min_temp",'name'=>"min_temp",'required'=> 'required' , 'value' => $symbol.defined_money_format( $min_temp , $precision ) ) );?>
                                                ...
                                                <td width="2%" height="30" class="wd_text">
                                                 ...
                                                 <td width="30%" height="31" style="padding-left:10px;">
                                                    ...
                                                    <?php echo form_input(array('type'=>"text",'class'=>"textbox",'id'=>"max_temp",'name'=>"max_temp",'required'=> 'required' , 'value' => $symbol.defined_money_format( $max_temp ,$precision  ) ) );?>
                                                </td>
                                                </tr>
                                              </tbody>
                                          </table>
