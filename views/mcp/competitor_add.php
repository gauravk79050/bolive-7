            ...
            <tbody>
              ...
              <td valign="middle" align="center" style="border:#8F8F8F 1px solid;">
                    ...
                    <tbody>
                      <tr>
                        <td align="center" style="padding:15px 0px 10px 0px"><table width="98%" cellspacing="0" cellpadding="0" border="0" style="background:url(<?php echo base_url();?>assets/mcp/images/bg.jpg) left top repeat-x;" class="page_caption">
                            <tbody>
                              <tr>
                                <td width="94%" align="left"><h3><?php echo _('Add COMPETITOR'); ?></h3></td>
                      ...
                      <tr>
						...
						<?php echo form_open('mcp/competitor/add',array('method'=>"post" ,'id'=>"frm_competitor_addedit", 'name'=>"competitor_add_edit"));?>
						
						<table width="98%" cellspacing="0" cellpadding="5" border="0" align="center" style="border:1px solid #003366; text-align:left;">
                            <tbody>
                            
                              <tr>
                                <td height="20" bgcolor="#003366" align="left" style="padding-left:10px;" class="whiteSmallBold" colspan="2"><?php echo _('Competitor Information'); ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td width="21%" height="30" class="wd_text"><?php echo _('Competitor Url'); ?><span class="red_star">*</span></td>
								...
								<?php echo form_input(array('name'=>"competitor_url",'id'=>"competitor_url",'width'=>'160px','class'=>'textbox'));?><?php if(@$host=='1'){?><span class="red_star">*<?php  echo "enter valid url like 'http://www.example.com'";?></span><?php }?>
								</td>
                              </tr>
                              <tr>
                                        ...
                                        <td valign="middle" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tbody>
                                              <tr>
                                                ...
                                                <td>												
												  <?php echo form_submit(array('name'=>'add','value'=>_('ADD COMPETITOR'),'class'=>'btnWhiteBack')); ?>
					...
					<script type="text/javascript">
						...
						frmUserFormValidator.addValidation("competitor_url","req","<?php echo _('Please select Country.'); ?>");		
					</script>
                  </td>
                </tr>
              </tbody>
