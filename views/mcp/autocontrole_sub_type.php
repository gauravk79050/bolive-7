                            ...
                            <tbody>
                              <tr>
                                ...
                                <td width="40%" align="right">
                                  ...
                                  <div style="background-image:url(<?php echo base_url(); ?>assets/mcp/images/add.png);float:right;" title="<?php echo _('Add New Sub Type'); ?>" class="icon_button" onClick="window.location.href='<?php echo base_url();?>mcp/autocontrole/sub_type_addedit'" id="btn_add">
                                  </div>
                                </td>
                              </tr>
                            </tbody>
                                       ...
                                       <tr>
                                          <td style="border:#003366 1px solid" colspan="5" valign="middle" bgcolor="#FFFFFF">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                              <tbody>
                                                <?php
                                                  if( !empty( $autocontrole_sub_type ) ){
                                                    foreach ( $autocontrole_sub_type as $key => $sub_type ) { ?>
                                                      <tr>
                                                        <td width="7%"  valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $sub_type[ 'id' ]; ?>
                                                        </td>
                                                        <td width="20%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $sub_type[ 'sub_type_name_dch' ]; ?>
                                                        </td>
                                                        <td width="20%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $sub_type[ 'sub_type_name_fr' ]; ?>
                                                        </td>
                                                        <td width="13%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $sub_type[ 'sub_type_name_en' ]; ?>
                                                         </td>
                                                        <td width="20%"  valign="middle" bgcolor="#FFFFFF">
                                                          <span class="blackMediumNormal" style="padding:5px">
                                                            <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>mcp/autocontrole/sub_type_addedit/<?php echo $sub_type[ 'id' ]; ?>'" style="cursor:pointer">
                                                          </span>
                                                        </td>
                                                      </tr>
                                                    <?php }
		                                             ...
		                                             <tr>
		                                                <td  colspan="5" bgcolor="#FFFFFF" style="padding:10px;font-size:14px;">
		                                                   <p><?php echo _( 'No Sub Type are there.' ); ?></p>
		                                                </td>
		                                             </tr>
		                                          <?php } ?>
                                                </tbody>
