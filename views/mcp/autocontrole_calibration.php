...
if( strpos( current_url(), 'rp' ) > -1 ) {
  $edit_url = base_url().'rp/autocontrole/addedit_calibration/';
  $add_url = base_url().'rp/autocontrole/addedit_calibration';
} else {
  $edit_url = base_url().'mcp/autocontrole/addedit_calibration/';
  $add_url = base_url().'mcp/autocontrole/addedit_calibration';
}?>
                                  ...
                                  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:url(<?php echo base_url(); ?>assets/mcp/images/pink_table_bg.jpg) left repeat; text-align:left;">
                                    <tbody style="border:#003366 1px solid">
                                      <tr>
                                        ...
                                        <td width="15%" class="whiteSmallBold" align="center"><?php echo _('Reference Temperature'); ?></td>
                                        <td width="15%" class="whiteSmallBold" align="center"><?php echo _('Ideal Temperature'); ?></td>
                                        <td width="15%" class="whiteSmallBold" align="center"><?php echo _('Options'); ?></td>
                                      </tr>
                                       <tr>
                                                    ...
                                                    foreach ( $autocontrole_temp_group as $key => $value ) { ?>
                                                      <tr>
                                                        ...
                                                        <td width="15%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'workroom_name_dch' ]; ?>
                                                        </td>
                                                        <td width="15%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'workroom_name_fr' ]; ?>
                                                        </td>
                                                        <td width="15%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'workroom_name' ]; ?>
                                                         </td>
                                                          <td width="15%" align="center" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'reference_temp' ].'&deg C'; ?>
                                                         </td>
                                                         <td width="15%" align="center" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                        ...
                                                        <td width="15%" align="center" valign="middle" bgcolor="#FFFFFF">
                                                          ...
                                                          <img class="delete_workroom" src="<?php echo base_url( '/assets/mcp/images/delete.jpg' );?> " alt="Delete" title="Delete" data-id="<?php echo $value[ 'id' ]; ?>" border="0" width="16" height="16">
                                                        </td>
                                                      </tr>
                                                    <?php }
                                                  }else{ ?>
...
<script type="text/javascript">
  ...
  $( document ).on( 'click','.delete_workroom' , function( ){ 
    var $this = $( this );
    var id = $this.data( 'id' );
    if( confirm( delete_auto_temp_group ) ){
      $.ajax({
        url : base_url + section+'/autocontrole/delete_calibration',
        data: {
          'id' : id,
        },
        async : !1,
