              ...
              <tbody>
                <tr>
                  <td valign="middle" align="center" style="border:#8F8F8F 1px solid;">
				    <?php echo form_open_multipart("mcp/company_type/company_type_add",array('method'=>"post" ,'id'=>"frm_company_type_addedit", 'name'=>"frm_company_type_addedit"));?>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td align="center" style="padding-bottom:15px"><table width="98%" cellspacing="0" cellpadding="5" border="0" align="center" style="border:1px solid #003366; text-align:left;">
                            <tbody>
                              <tr>
                                <td height="20" bgcolor="#003366" align="left" style="padding-left:10px;" class="whiteSmallBold" colspan="2"><?php echo _('Add Company Type'); ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td width="79%" height="31" style="padding-left:10px;"><?php echo form_input(array('type'=>"text",'style'=>"width:140px", 'class'=>"textbox",'id'=>"company_type_name",'name'=>"company_type_name"));?></td>
                              </tr>
                               <tr>
                                        ...
                                        <td valign="middle" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tbody>
                                              <tr>
                                                ...
                                                <td><?php echo form_submit(array('id'=>'add','name'=>'add','value'=>'ADD COMPANY TYPE','class'=>'btnWhiteBack'));?></td>
                                              </tr>
                                            </tbody>
                                          </table></td>
                                      </tr>
