		...
		function(data){
			...
			if( data.subcategories.length || data.products.length )
			{
				...
				if( data.products && data.products.length )
				{
				   ...
				   {
				       html_txt += '<option value="'+data.products[i].id+'">'+data.products[i].proname+'</option>';
				   }
	...
	if( subcategory_id )
	{
		...
		function(data){
			...
			{				   
			   ...
			   {
				   html_txt += '<option value="'+data[i].id+'">'+data[i].proname+'</option>';
			   }
                               ...
                               <table>
                                  ...
                                  <tbody>                            
                                    ...
                                    <tr id="org_<?php echo $od->ID; ?>">
                                        <td><?php echo $od->proname; ?></td>
                                        <td><?php echo $od->quantity.( ($od->content_type==1)?' Gr.':'' ); ?></td>
                                        ...
                                        <td>
										    <a href="javascript:void(0);" title="<?php echo _('Edit product options.'); ?>" onclick="edit_order_product('<?php echo $od->ID; ?>','<?php echo $od->product_id; ?>','<?php echo $od->content_type; ?>');"> <img src="<?php echo base_url(); ?>assets/cp/images/edit.gif" /></a>&nbsp;|&nbsp;<a href="<?php echo base_url(); ?>obsdesk_cp/orders/remove_prod/<?php echo $od->ID; ?>/<?php echo $order->id; ?>/<?php echo $od->product_id; ?>" title="<?php echo _('Remove this product from order.'); ?>"><img src="<?php echo base_url(); ?>assets/cp/images/delete.gif" height="16" width="16" /></a>
                                        </td>
                                    </tr>
                                    <tr id="edit_<?php echo $od->ID; ?>" style="display:none;"><td colspan="6" style="padding:0px;">
                                    <form method="post" action="<?php echo base_url(); ?>orders/edit_ordered_product" id="edit_ordered_product_<?php echo $od->ID; ?>">
                                        ...
                                        <table width="100%"><tr>
                                        <td width="20%" style="border:0px;"><?php echo $od->proname; ?></td>
