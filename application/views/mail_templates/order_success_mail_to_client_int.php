  			...
  			<tr>
    			<td>
          					...
          					<td width="100%" valign="top" colspan="2">
          						<table width="100%" border="0" cellspacing="0" cellpadding="2">
              						<tr>
                						...
                						<td bgcolor="#F0F0F0"><b><?php echo $this->lang->line('mail_delivery_address'); ?>:</b></td>
                						<?php /* ?>
              						...
              						<tr>
			    						...
			    						<td>
                							<strong>
								                ...
								                <?php echo stripslashes($order_data['delivery_streer_address']);?>&nbsp;<br />
								                <?php echo $order_data['delivery_zip']; if($order_data['delivery_city'] != '0'){?> - <?php echo stripslashes($order_data['delivery_city']);}?><br/><?php //echo $order_data['delivery_area'];?>
								                <?php 
								                /* if(isset($countries[$order_data['delivery_country']])){
													echo $countries[$order_data['delivery_country']]->country_name;
								                } */	
												if(isset($order_data['delivery_country_name'])){
													echo $order_data['delivery_country_name'];
												}
								                ?><br/>
								                <?php echo $this->lang->line('mail_mobile');?> :&nbsp;<?php echo $order_data['phone_reciever'];?><br />
								            </strong>
			    						</td>
              						</tr>
              						<tr>
              							<td colspan="2">
              								<?php if(isset($order_data['delivery_country']) && $order_data['delivery_country'] == 21 && isset($order_data['delivery_date']) && $order_data['delivery_date'] != '' && $order_data['delivery_date'] != '0000-00-00'){ ?>
              									<br/><strong><?php echo $this->lang->line('mail_delivery_day'); ?> :</strong> <?php echo date('d/m/Y',strtotime($order_data['delivery_date'].' 00:00:00')); ?>
              								<?php } ?>
              							 	<?php if(isset($order_data['delivery_remarks']) && trim($order_data['delivery_remarks']) != ''){ ?>
							            		<br/><strong><?php echo $this->lang->line('mail_delivery_note'); ?> :</strong> <?php echo stripslashes($order_data['delivery_remarks']); ?><br/> 
							            	<?php } ?>
              							</td>
              						</tr>
              						<tr>
              							<td>
              								<strong>
								                ...
								                <?php //if($order_data['name'] != ''){?>
								                	<?php //echo $order_data['name'];?><br />
								                <?php //}?>
								                <?php echo $this->lang->line('mail_mobile');?> :&nbsp;<?php echo $client->phone_c;?><br />
												<?php /*echo $this->lang->line('mail_mobile');?> :&nbsp;<?php echo $client->mobile_c;?><br />
					...
					<ul>
						...
						<li><strong><?php echo $this->lang->line('mail_pickup_note'); ?> :</strong> <?php echo $order_data['order_remarks']; ?></li>
						<li><strong><?php echo $this->lang->line('mail_shop'); ?> :</strong> <?php echo $company_name; ?></li>
					</ul>
					<?php }elseif( $order_data['option'] == '2' ){ ?>
					<ul>
						<!-- <li><b><?php echo $this->lang->line('mail_delivery_date'); ?> :</b> <?php echo date('d/m/Y',strtotime($order_data['delivery_date'].' 00:00:00')); ?></li> -->
						...
						<li><strong><?php echo $this->lang->line('mail_delivery_note'); ?> :</strong> <?php echo $order_data['delivery_remarks']; ?></li>
					</ul>
					<?php }*/ ?>
      			</td>
  			</tr>
