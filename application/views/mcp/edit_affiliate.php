                ...
                <td valign="top" align="center" style="border:#003366 1px solid; padding:15px 0px 0px 0px"><table width="98%" cellspacing="0" 
				 cellpadding="0" border="0">
                    <tbody>
                      <tr>
                        <td align="center" style="padding-bottom:10px"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background
						  :url(<?php echo base_url(); ?>assets/mcp/images/bg.jpg) left top repeat-x;" class="page_caption">
                            <tbody>
                              <tr height="26">
                                <td width="50%" align="left"><h3><?php echo _('Edit Affiliate Details'); ?></h3></td>
                              </tr>
                            </tbody>
                          </table></td>
                      </tr>
                      <tr>
                        <td align="center">
						   <table width="100%" cellspacing="0" cellpadding="0" border="0" class="blackMediumNormal">                           <form method="post" action="<?php echo base_url(); ?>mcp/affiliates/edit_affiliate/<?php echo $affiliate->id; ?>" name="frm_edit_affiliate" id="frm_edit_affiliate">
                            <tbody>
								 ...
								 <td width="50%">
								    <table align="center">
									   ...
									   <!-- <tr>
										  ...
										  <td><input type="text" name="a_monthly_income" id="a_monthly_income" value="<?php echo $affiliate->a_monthly_income; ?>" class="textbox"></td>
									   </tr> -->
									   <!--<tr>
							  ...
							  <tr>
							    <td colspan="2" align="center">
								   ...
								   <input type="submit" name="update_affiliate" id="update_affiliate" value="<?php echo _('UPDATE AFFILIATE'); ?>" class="btnWhiteBack">
								</td>
							  </tr>
							  <tr>
							    <td colspan="2">&nbsp;</td>
