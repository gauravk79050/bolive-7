                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td width="20%" align="right">
                                      ...
                                      <div style="background-image:url(<?php echo base_url();?>assets/mcp/images/add.png);float:right;" title="Add Predifined" class="icon_button" onClick="window.location.href='<?php echo base_url();?>mcp/autocontrole/addeditPredifined'" id="btn_add"></div>
                                    </td>
                                  </tr>
                                </tbody>
                            </table>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td valign="middle" bgcolor="#FFFFFF" style="border:#003366 1px solid; padding:5px">
                                           <?php echo form_open_multipart( "mcp/autocontrole/searchPredifined",array( 'method'=>"post" ,'id'=>"frm_autocontrole_predifined_srch", 'name'=>"frm_autocontrole_predifined_srch")); ?>
										                        <table width="100%" cellspacing="0" cellpadding="0" border="0">  
										                          <tbody>
                                                <tr>
                                                             ...
                                                             <td width="7%" >
                                                              ...
                                                              <td width="5%"  align="center" class="blackMediumNormal" >
                                                                <span class="blackMediumNormal" style="padding:5px">
                                                                  <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>mcp/autocontrole/addeditPredifined/<?php echo $value[ 'id' ]; ?>'" style="cursor:pointer">
