        ...
        <td align="center"><table width="430" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="302" valign="top" bgcolor="#8992AD" style="padding-left:5px">
			   <?php echo form_open("mcp/mcplogin/match",array('name'=>"frm_login",'id'=>"frm_login",'method'=>"post"));?>
                ...
                <table width="293" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="215" align="left"><?php echo form_input(array('name'=>"login_username",'id'=>"login_username",'class'=>"textbox"));?></td>
                  </tr>
                  <tr>
                    <td height="24" align="left" class="whiteSmallBold"><?php echo _('Password')?></td>
                    <td align="left"><?php echo form_password(array('name'=>"login_password",'id'=>"login_password",'class'=>"textbox"));?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="22">&nbsp;</td>
                    <td align="right" valign="bottom"><?php  echo anchor(base_url()."mcp/mcplogin/forgot_password",_('Forgot Password?'))?></a></td>
				...
				<script type="text/javascript">
					...
					frmvalidator.addValidation("login_username","req","<?php echo _('Please enter your login Username');?>");
					frmvalidator.addValidation("login_password","req","<?php echo _('Please enter your login Password');?>");
				</script>             
              </td>
            </tr>
          </table></td>
