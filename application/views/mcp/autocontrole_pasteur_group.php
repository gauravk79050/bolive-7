                            ...
                            <tbody>
                              <tr>
                                <td width="40%" align="left">
                                  <h3><?php echo _('Pasteurisation Group'); ?></h3>
                                </td>
                                ...
                                <td width="40%" align="right">
                                  ...
                                  <div style="background-image:url(<?php echo base_url(); ?>assets/mcp/images/add.png);float:right;" title="<?php echo _('Add New Pasteurisation Group'); ?>" class="icon_button" onClick="window.location.href='<?php echo base_url();?>mcp/autocontrole/addedit_pasteur_group/<?php echo $country_code;?>'" id="btn_add">
                                  </div>
                                </td>
                              </tr>
                            </tbody>
                                  ...
                                  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:url(<?php echo base_url(); ?>assets/mcp/images/pink_table_bg.jpg) left repeat; text-align:left;">
                                    <tbody style="border:#003366 1px solid">
                                      <tr>
                                       ...
                                       <tr>
                                          <td style="border:#003366 1px solid" colspan="6" valign="middle" bgcolor="#FFFFFF">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                              <tbody>
                                                <?php
                                                  if( !empty( $autocontrole_pasteur_group ) ){
                                                    foreach ( $autocontrole_pasteur_group as $key => $value ) { ?>
                                                      <tr>
                                                        ...
                                                        <td width="20%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'pasteur_name_dch' ]; ?>
                                                        </td>
                                                        <td width="20%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'pasteur_name_fr' ]; ?>
                                                        </td>
                                                        <td width="20%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'pasteur_name' ]; ?>
                                                         </td>
                                                        ...
                                                        <td width="20%" align="center" valign="middle" bgcolor="#FFFFFF">
                                                          <span class="blackMediumNormal" style="padding:5px">
                                                            <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>mcp/autocontrole/addedit_pasteur_group/<?php echo $value[ 'id' ]; ?>/<?php echo $country_code;?>'" style="cursor:pointer">
                                                          </span>
                                                          <img class="delete_pasteur_group" src="<?php echo base_url( '/assets/mcp/images/delete.jpg' );?> " alt="Delete" title="Delete" data-id="<?php echo $value[ 'id' ]; ?>" border="0" width="16" height="16">
                                                        </td>
                                                      </tr>
                                                    <?php }
                                                  }else{ ?>
		                                             <tr>
		                                                <td  colspan="6" bgcolor="#FFFFFF" style="padding:10px;font-size:14px;">
		                                                   <p><?php echo _( 'No Pasteurisation Group are there.' ); ?></p>
		                                                </td>
		                                             </tr>
		                                          <?php } ?>
                                                </tbody>
