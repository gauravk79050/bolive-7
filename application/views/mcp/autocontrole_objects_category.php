                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td width="30%" align="right">
                                      ...
                                      <div style="background-image:url(<?php echo base_url();?>assets/mcp/images/add.png);float:right;" title="Add Category" class="icon_button" onClick="window.location.href='<?php echo base_url(); ?>mcp/autocontrole/addedit_objects_category'" id="btn_add"></div>
                                    </td>
                                  </tr>
                                </tbody>
                            </table>
                                          ...
                                          <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:url(images/pink_table_bg.jpg) left repeat; text-align:left;" class="auto_procedure_table">
                                            <thead>
                                              <tr>
                                                ...
                                                <td width="20%" class="whiteSmallBold"><?php echo _( 'Category Name-dch' ); ?></td>
                                                <td width="20%" class="whiteSmallBold"><?php echo _( 'Category Name-fr' ); ?></td>
                                                <td width="20%" class="whiteSmallBold"><?php echo _( 'Category Name-en' ); ?></td>
                                                <td width="15%" class="whiteSmallBold"><?php echo _( 'Type' ); ?></td>
                                                ...
                                                foreach ( $category as $key => $cat ) { ?>
                                                  <tr data-id="<?php echo $cat[ 'id' ]; ?>" class="proc_row">
                                                    ...
                                                    <td width="20%" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                      <?php  echo $cat[ 'object_name_dch' ]; ?>
                                                    </td>
                                                     <td width="20%" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                      <?php  echo $cat[ 'object_name_fr' ]; ?>
                                                    </td>
                                                     <td width="20%" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                      <?php  echo $cat[ 'object_name' ]; ?>
                                                    </td>
                                                    <td width="15%" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                      <?php 
                                                      if( $cat[ 'cat_type' ] == '1' ) {
                                                        echo _( "Objects" );
                                                    ...
                                                    <td width="20%" class="whiteSmallBold" bgcolor="#FFFFFF"  >
                                                      <span class="blackMediumNormal">
                                                          <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>mcp/autocontrole/addedit_objects_category/<?php echo $cat[ 'id' ]; ?>'" style="cursor:pointer">
                                                          <img style="padding-left:14px" width="16" height="16"  border="0" src="<?php echo base_url(); ?>assets/mcp/images/delete.jpg" alt="Delete" title="Delete" data-obj_id="<?php echo $cat[ 'id' ]; ?>" class="delete_object_category">
                                                        </span>
                                                    </td>
                                                  </tr>
                                              <?php }
