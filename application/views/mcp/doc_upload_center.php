...
.remove_me{
	...
	right: 0;
      ...
      <div id="notice"><strong><?php echo $this->session->flashdata('success');?></strong></div>
      <?php elseif($this->session->flashdata('error')):?>
      <div id="notice"><strong><?php echo $this->session->flashdata('error');?></strong></div>
      <?php endif;?>
      ...
      <div class="box" style="width: 98% !important;">	
        ...
        <div class="post">
			...
			<div style="text-align: center; background-color: #2E3134; padding: 20px;">
			  <form id="imageform" method="post" enctype="multipart/form-data" action='<?php echo base_url()?>mcp/mail_manager/doc_manager'>
