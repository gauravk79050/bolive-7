...
if( strpos( current_url(), 'rp' ) > -1 ) {
  $edit_url = base_url().'rp/autocontrole/addedit_ph_groups/';
  $add_url = base_url().'rp/autocontrole/addedit_ph_groups';
} else {
  $edit_url = base_url().'mcp/autocontrole/addedit_ph_groups/';
  $add_url = base_url().'mcp/autocontrole/addedit_ph_groups';
}?>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td width="40%" align="right">
                                  ...
                                  <div style="background-image:url(<?php echo base_url(); ?>assets/mcp/images/add.png);float:right;" title="<?php echo _('Add New PH Group'); ?>" class="icon_button" onClick="window.location.href='<?php echo $add_url;?>'" id="btn_add">
                                  </div>
                                </td>
                              </tr>
                            </tbody>
                                  ...
                                  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:url(<?php echo base_url(); ?>assets/mcp/images/pink_table_bg.jpg) left repeat; text-align:left;">
                                    <tbody style="border:#003366 1px solid">
                                      <tr>
                                        ...
                                        <td width="15%" class="whiteSmallBold"><?php echo _('Dutch'); ?></td>
                                        <td width="15%" class="whiteSmallBold"><?php echo _('French'); ?></td>
                                        <td width="15%" class="whiteSmallBold"><?php echo _('English'); ?></td>
                                        <td width="15%" class="whiteSmallBold" align="center"><?php echo _('Group Value'); ?></td>
                                        <td width="30%" class="whiteSmallBold" align="center"><?php echo _('Options'); ?></td>
                                      </tr>
                                       <tr>
                                          <td style="border:#003366 1px solid" colspan="12" valign="middle" bgcolor="#FFFFFF">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                              <tbody>
                                                <?php
                                                  if( !empty( $autocontrole_ph_groups ) ){
                                                    foreach ( $autocontrole_ph_groups as $key => $value ) { ?>
                                                      <tr>
                                                        ...
                                                        <td width="15%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'grp_name_dch' ]; ?>
                                                        </td>
                                                        <td width="15%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'grp_name_fr' ]; ?>
                                                        </td>
                                                        <td width="15%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'grp_name' ]; ?>
                                                         </td>
                                                          <td width="15%" align="center" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $value[ 'grp_val' ]; ?>
                                                         </td>
                                                        <td width="45%" align="center" valign="middle" bgcolor="#FFFFFF">
                                                          ...
                                                          <img class="delete_ph_groups" src="<?php echo base_url( '/assets/mcp/images/delete.jpg' );?> " alt="Delete" title="Delete" data-id="<?php echo $value[ 'id' ]; ?>" border="0" width="16" height="16">
                                                        </td>
                                                      </tr>
                                                    <?php }
                                                  }else{ ?>
		                                             <tr>
		                                                <td  colspan="6" bgcolor="#FFFFFF" style="padding:10px;font-size:14px;">
		                                                   <p><?php echo _( 'No Groups are there.' ); ?></p>
		                                                </td>
		                                             </tr>
		                                          <?php } ?>
                                                </tbody>
...
<script type="text/javascript">
  ...
  $( document ).on( 'click','.delete_ph_groups' , function( ){ 
    var $this = $( this );
    var id = $this.data( 'id' );
    if( confirm( delete_auto_temp_group ) ){
      $.ajax({
        url : base_url + section+'/autocontrole/delete_ph_groups',
        data: {
          'id' : id,
        },
        async : !1,
