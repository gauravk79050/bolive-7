...
if (isset($division_id) && $division_id !='' && $division_id !=0 ) { ?>
      ...
      <td align="center" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="top" style="border:#8F8F8F 1px solid">
           ...
           <?php $division = ''; if(isset($division_comp)) { $division = $division_comp[0]; } ?> 
           <?php $subcomp_id =  (isset($subcomp_id) && $subcomp_id !=0) ? $subcomp_id  : 0  ?>
           <?php echo form_open('mcp/companies/division_add_edit/'.$ID, array('id'=>'frm_subdomain_add_edit')); ?>

           <input type="hidden" name="subcomp_id" value="<?= $subcomp_id ?>"> 
           <input type="hidden" name="approved" size="25" value="<?php if(isset($division_comp)) {echo ($division->approved)?1:0; } else { echo 0; } ?>" />
           <input type="hidden" name="status" size="25" value="<?php if(isset($division_comp)) {echo ($division->status)?1:0; } else { echo 0; } ?>" /> 
           ...
           <div>
              ...
              <td align="center" style="padding:15px 0px 5px 0px"><table class="page_caption" style="background:url(<?php echo base_url(); ?>assets/mcp/images/bg.jpg) left top repeat-x;" width="98%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="94%" align="left"><h3>
                   <?php echo ( $division_id != 0 && $division_id != '')?"Edit ":"Add "; ?> Division</h3></td>
                ...
                <tr>
                  <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td width="20%"><input type="text" name="company_name" size="25" value="<?php if(isset($division_comp))echo $division->company_name; ?>" /></td>
                    </tr>
                    <tr>
                      <td height="30" class="wd_text">First Name</td>
                      <td><input type="text" name="first_name" size="25" value="<?php if(isset($division_comp))echo $division->first_name; ?>"/></td>
                    </tr>
                    <tr>
                      <td height="30" class="wd_text">Last Name</td>
                      <td><input type="text" name="last_name" size="25" value="<?php if(isset($division_comp))echo $division->last_name; ?>"/></td>
                    </tr>
                    <tr>
                      <td height="30" class="wd_text">Email</td>
                      <td><input type="text" name="email" id="email" size="25" value="<?php if(isset($division_comp))echo $division->email; ?>"/></td>
                    </tr>
                    <tr>
                      <td height="30" class="wd_text">Phone</td>
                      <td><input type="text" name="phone" size="25" value="<?php if(isset($division_comp))echo $division->phone; ?>"/></td>
                    </tr>
                  </table></td>
                  <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="25%" height="30" class="wd_text">Address</td>
                      <td width="25%"><input type="text" name="address" size="25" value="<?php if(isset($division_comp))echo $division->address; ?>"/></td>
                    </tr>
                    <tr>
                      <td height="30" class="wd_text">City</td>
                      <td><input type="text" name="city" size="25" value="<?php if(isset($division_comp))echo $division->city; ?>"/></td>
                    </tr>
                    <tr>
                      <td height="30" class="wd_text">Zipcode</td>
                      <td><input type="text" name="zipcode" size="25" value="<?php if(isset($division_comp))echo $division->zipcode; ?>"/></td>
                    </tr>
                    <tr>
                      <td height="30" class="wd_text">Username</td>
                      <td><input type="text" id="username" name="username" size="25" onchange="check_username(this.value);" value="<?php if(isset($division_comp))echo $division->username; ?>"/></td>
                    </tr>
                    <tr>
            ...
            <tr>
              <td align="center" style="padding:20px;"><input type="submit" name="btn_add_update" size="25" class="btnWhiteBack" value="<?php echo ($division_id != 0 && $division_id != '')?"UPDATE ":"TOEVOEGEN "; ?>" />
        ...
        <script language="javascript" type="text/javascript">
          ...
          var division_id = "<?php if($division_id != 0 && $division_id != '') echo $division_id; ?>";
            ...
            if ( jQuery('#email').val() != '' ) {
              jQuery.ajax({
                ...
                data:{
                  ...
                  comp_id : division_id ? division_id : ''
                },
                async :false,
