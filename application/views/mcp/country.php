                      ...
                      <tbody>
                        <tr>
                          <td align="center" style="padding-bottom:5px"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:url(<?php echo base_url();?>assets/mcp/images/bg.jpg) left top repeat-x;" class="page_caption">
                              <tbody>
                                <tr>
                                  <td width="50%" align="left"><h3><?php echo _('Country Manager'); ?></h3></td>
                                  <td width="50%" align="right"><div onclick="history.back();" title="Back" style="background-image:url(<?php echo base_url();?>assets/mcp/images/undo.jpg); cursor:pointer; float:right" class="icon_button"></div>
                                    <div style="background-image:url(<?php echo base_url();?>assets/mcp/images/add.png);float:right;" title="Add Country" class="icon_button" onClick="window.location.href='<?php echo base_url();?>mcp/country/add'" id="btn_add"></div></td>
                                </tr>
                              </tbody>
                            </table>
						   </td>
                           ...
                           <tbody>
                             <tr>
                                <td style="padding-top:5px"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:url(images/pink_table_bg.jpg) left repeat; text-align:left">
                                    <tbody>
                                        <tr>
                                          <td valign="middle" height="20" bgcolor="#003366" align="left" style="border:#003366 1px solid; padding-left:5px" class="whiteSmallBold"><?php echo _('Search Country'); ?></td>
                                        </tr>
                                        <tr>
                                          <td valign="middle" bgcolor="#FFFFFF" style="border:#003366 1px solid; padding:5px">
										  <?php 
										    $js="onSubmit='return searchblank()'";
										   echo form_open("mcp/country",array('name'=>'searchform','id'=>'searchform'));?>
										  <table width="100%" cellspacing="0" cellpadding="0" border="0">  
										    <tbody>
                                                <tr>
                                                  ...
                                                  <td width="126"><?php
													   ...
													   $options=array('0'=>'- - Search By - -','id'=>'ID','country'=>'Country Name');
                                  ...
                                  <td bgcolor="#003366"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:url(images/pink_table_bg.jpg) left repeat; text-align:left;">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td width="43%" class="whiteSmallBold"><?php echo _('Country Name'); ?></td>
						...
						<tbody>
                            ...
                            <?php  foreach($country as $d){ ?>
                                                 <tr>
                                                  ...
                                                  <td width="43%" class="blackMediumNormal"><?=$d->country_name ?></td>
                                                  <td width="50%" align="right" style="padding-right:40px" class="blackMediumNormal"><span style="padding:5px" class="blackMediumNormal"><img width="16" height="16" border="0" style="cursor:pointer" onClick="window.location.href='<?php echo base_url();?>mcp/country/update/<?php echo $d->id?>/<?php echo $d->country_name?>'" title="Edit" alt="Edit" src="<?php echo base_url();?>assets/mcp/images/edit.jpg"></span></td>
											   </tr>
                             <?php } } else { ?>
							   <tr>
							      <td colspan="3" style="padding:10px;font-size:14px;">
							         <p><?php echo _('No countries are there.'); ?></p>
							      </td>
							   </tr>
							 <?php } ?>
                     </tbody>
