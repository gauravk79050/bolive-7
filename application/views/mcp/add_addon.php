<div style="width:100%">
  <form action="<?php echo base_url(''); ?>mcp/addon/insert" enctype="multipart/form-data" method="post" id="frm_addon_addedit" name="frm_addon_addedit">
      ...
      <tbody>
        <tr>
          ...
          <td valign="top" align="center"><table width="98%" cellspacing="0" cellpadding="0" border="0">
              <tbody>
                <tr>
                  <td valign="middle" align="center" style="border:#8F8F8F 1px solid;"><input type="hidden" value="addon_addedit" name="OBS BEstelsysteem - SiteMatic BVBA_REF_VIEW">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tbody>
                        <tr>
                          <td align="center" style="padding:15px 0px 10px 0px"><table width="98%" cellspacing="0" cellpadding="0" border="0" style="background:url('<?php echo site_url('mcp/images/bg.jpg');?>') left top repeat-x;" class="page_caption">
                              <tbody>
                                <tr>
                                  <td width="94%" align="left"><h3><?php echo _('Add Addon'); ?></h3></td>
                          ...
                          <td align="center" style="padding-bottom:15px"><table width="98%" cellspacing="0" cellpadding="5" border="0" align="center" style="border:1px solid #003366; text-align:left;">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td width="79%" height="31" style="padding-left:10px;"><input type="text" style="width:160px" class="textbox" id="addon_name" name="addon_name"></td>
                                </tr>
                                <tr>
                                  <td width="21%" height="30" class="wd_text"><?php echo _('Addon Desciption'); ?><span class="red_star">*</span></td>
                                  <td width="79%" height="31" style="padding-left:10px;"><textarea cols="30" rows="3" class="textbox" type="textarea" id="addon_desc" name="addon_desc"></textarea></td>
                                </tr>
                                <tr>
                                  <td width="21%" height="30" class="wd_text"><?php echo _('Addon Price'); ?><span class="red_star">*</span></td>
                                  <td width="79%" height="31" style="padding-left:10px;"><input type="text" style="width:160px" class="textbox" id="addon_price" name="addon_price"></td>
                                </tr>
                                <tr>
                                          ...
                                          <td valign="middle" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td><input type="submit" value="<?php echo _('ADD ADDON'); ?>" class="btnWhiteBack" id="btn_add_update" name="btn_add_update" >
  ...
  <script type="">
	...
	frmUserFormValidator.addValidation("addon_name","req","<?php echo _('Please enter the Addon Name'); ?>");	
	frmUserFormValidator.addValidation("addon_desc","req","<?php echo _('Please enter the Addon Description'); ?>");	
