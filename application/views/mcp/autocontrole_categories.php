<script type="text/javascript">
  var  delete_auto_type =  '<?php echo _( "The tasks related to this will also be affected. Would you like to remove it from MCP Panel ?" );?>';
</script>
<div style="width:100%">
  <!-- start of main body -->
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td width="40%" align="right">
                                  ...
                                  <div style="background-image:url(<?php echo base_url(); ?>assets/mcp/images/add.png);float:right;" title="<?php echo _('Add New Company Type'); ?>" class="icon_button" onClick="window.location.href='<?php echo base_url();?>mcp/autocontrole/autocontrole_categories_addedit'" id="btn_add">
                                  </div>
                                </td>
                              </tr>
                            </tbody>
                                       ...
                                       <tr>
                                          <td style="border:#003366 1px solid" colspan="5" valign="middle" bgcolor="#FFFFFF">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                              <tbody>
                                                <?php
                                                  if( !empty( $autocontrole_categories ) ){
                                                    foreach ( $autocontrole_categories as $key => $categories ) { ?>
                                                      <tr>
                                                        ...
                                                        <td width="20%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $categories[ 'type_name_dch' ]; ?>
                                                        </td>
                                                        <td width="20%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $categories[ 'type_name_fr' ]; ?>
                                                        </td>
                                                        <td width="13%" valign="middle" bgcolor="#FFFFFF" class="blackMediumNormal">
                                                          <?php echo $categories[ 'type_name' ]; ?>
                                                         </td>
                                                        <td width="20%"  valign="middle" bgcolor="#FFFFFF">
                                                          <span class="blackMediumNormal" style="padding:5px">
                                                            <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>mcp/autocontrole/autocontrole_categories_addedit/<?php echo $categories[ 'id' ]; ?>'" style="cursor:pointer">
                                                          </span>
                                                          <img class="delete_type" src="<?php echo base_url( '/assets/mcp/images/delete.jpg' );?> " alt="Delete" title="Delete" data-id="<?php echo $categories[ 'id' ]; ?>" border="0" width="16" height="16">
                                                        </td>
                                                      </tr>
                                                    <?php }
                                                  }else{ ?>
		                                             <tr>
		                                                <td  colspan="5" bgcolor="#FFFFFF" style="padding:10px;font-size:14px;">
		                                                   <p><?php echo _( 'No type are there.' ); ?></p>
		                                                </td>
		                                             </tr>
		                                          <?php } ?>
                                                </tbody>
