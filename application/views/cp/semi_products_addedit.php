...
<div id="main-header">
  <h2>
    <?php if($product_information): echo _('UPDATE SEMI-PRODUCT');else: echo _('ADD SEMI-PRODUCT'); endif;?>
  </h2>
				                	...
				                	<?php //if(!isset($product_information) || empty($product_information) || (isset($product_information) && !empty($product_information) && $product_information['0']->direct_kcp == 0)) {  ?>
				              		...
				              		<div id="fdd_tools" <?php if(isset($product_information) && !empty($product_information)){ }else{ }?>>
					              		...
					              		<?php if($fdd_credits > 0){?>
						              		...
						              		<?php if(isset($product_information) && !empty($product_information)){?>
						              			<a href="<?php echo base_url().'cp/fooddesk/fdd_own_products/'.$product_information['0']->id.'?height=300&width=900'?>" title="<?php echo _('Add Recipe of PRODUCT ');  echo $product_information['0']->proname; ?>" class="thickbox"><?php echo _('FoodDESK/Own products')?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						              		<?php }else{?>
						              			<a href="<?php echo base_url().'cp/fooddesk/fdd_own_products?height=300&width=900'?>" title="<?php echo _('Add FoodDESK or Own products');?>" class="thickbox"><?php echo _('FoodDESK/Own products')?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						              		<?php }?>
...
//														}
			                                		...
			                                		<?php }?>
		                                			<td width="32%" style="vertical-align: sub; padding-left:5px;">
...
//														}
		          ...
		          <input type="hidden" value="1" id="semi_products" name="semi_products" >
		        </form>
