...
<script type="text/javascript" src="<?php echo base_url();?>assets/cp/new_js/jquery-migrate-1.2.1.js"></script><?php //http://code.jquery.com/jquery-migrate-1.2.1.js?>
...
function do_upload(obj){
	...
	jQuery("#imageform").ajaxSubmit({
		...
		url: '<?php echo base_url()?>cp/mail_manager/ajax_image_upload',
		type:'post',
