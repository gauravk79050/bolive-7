...
function do_upload(obj){
    ...
    jQuery("#imageform").ajaxSubmit({
		...
		url: '<?php echo base_url()?>cp/mail_manager/ajax_file_upload',
		type:'post',
		...
		success: function(response){
			...
			//jQuery('#attach_span').html(file_name);
		    tb_remove();
		},
...
<div style="text-align: center; background-color: #2E3134; padding: 20px;">
  <form id="imageform" method="post" enctype="multipart/form-data" action='<?php echo base_url()?>cp/mail_manager/ajax_file_upload'>
