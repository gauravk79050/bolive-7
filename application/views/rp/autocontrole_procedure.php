                  ...
                  <td valign="top" align="center" style="border:#003366 1px solid; padding:15px 0px 0px 0px">
                    <table width="98%" cellspacing="0" cellpadding="0" border="0">
                      <tbody>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td width="30%" align="right">
                                      ...
                                      <div style="background-image:url(<?php echo base_url();?>assets/mcp/images/add.png);float:right;" title="Add Predifine" class="icon_button" onClick="window.location.href='<?php echo base_url();?>rp/autocontrole/addeditprocedure'" id="btn_add"></div>
                                    </td>
                                  </tr>
                                </tbody>
                            </table>
                        ...
                        <tr>
                          <td align="center">
                            <?php echo form_open_multipart( "rp/autocontrole/searchProcedure",array( 'method'=>"post" ,'id'=>"frm_autocontrole_procedure_srch", 'name'=>"frm_autocontrole_procedure_srch")); ?>
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                              <tbody>
                                <tr>
                                                    ...
                                                    <td width="20%" class="whiteSmallBold" bgcolor="#FFFFFF"  >
                                                      <span class="blackMediumNormal autocontrole_operations" style="padding:5px">
                                                        <?php if( $procedure[ 'file_dch' ] != '' ){ ?>
                                                          ...
                                                          <?php } ?>
                                                          <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>rp/autocontrole/addeditprocedure/<?php echo $procedure[ 'id' ]; ?>'" style="cursor:pointer">
