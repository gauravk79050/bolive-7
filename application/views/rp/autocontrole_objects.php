                        ...
                        <tbody>
                          <tr>
                           ...
                           <td width="40%" align="right">
                               <div style="background-image:url(<?php echo base_url();?>assets/mcp/images/add.png);float:right;" title="Add Objects" class="icon_button" onClick="window.location.href='<?php echo base_url();?>rp/autocontrole/addObjects'" id="btn_add"></div>
                            </td>
                          </tr>
                        </tbody>
                      </table></td>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td valign="middle" bgcolor="#FFFFFF" style="border:#003366 1px solid; padding:5px">
                             <?php echo form_open_multipart( "rp/autocontrole/searchObjects",array( 'method'=>"post" ,'id'=>"frm_autocontrole_objects_srch", 'name'=>"frm_autocontrole_objects_srch")); ?>
                              <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                  <tr>
                          ...
                          <tr class="pqrop">
                            ...
                            <tbody>
                              <tr>
                                <td width="3%"  class="whiteSmallBold">
                                  <?php echo _( 'ID' ); ?>
                                </td>
                                <td width="15%" class="whiteSmallBold">
                                  <?php echo _( 'Object name Fr' ); ?>
                                </td>
                                <td width="15%" class="whiteSmallBold">
                                  <?php echo _( 'Object name Dch' ); ?>
                                </td>
                                <td width="15%" class="whiteSmallBold">
                                ...
                                <td width="16%" class="whiteSmallBold">
                                  <?php echo _( 'Company Type' ); ?>
                                </td>
                                 <td width="15%" class="whiteSmallBold">
                                  <?php echo _( 'Related Type' ); ?>
                                </td>
                                <td width="6%" class="whiteSmallBold">
                                  <?php echo _('Options'); ?>
                                </td>
                              </tr>
                            <?php
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                      <tbody>
                                        <tr data-key="<?php echo $k; ?>">
                                           <td width="3%" class="blackMediumNormal" ><?php echo $value[ 'o_id' ]; ?></td>
                                            ...
                                            <td width="6%" class="blackMediumNormal" >
                                              <span class="blackMediumNormal" style="padding:5px">
                                                <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>rp/autocontrole/editObjects/<?php echo $value[ 'o_id' ]; ?>'" style="cursor:pointer">
