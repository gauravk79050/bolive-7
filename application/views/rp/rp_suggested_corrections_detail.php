	...
	<body>
		...
		<!-- start of main body -->
			<div id="show_company_<?php echo $suggestion['id'];?>" style="padding: 20px 0px;">
		  		...
		  		<form class="form-horizontal" action="<?php echo base_url(); ?>rp/reseller/approve_suggestion"  method="post" id="frm_suggestion_add" name="frm_suggestion_add">
			  		<div class="wrap">
			            ...
			            <div id="opening-hours" class="container" style="margin-bottom: 20px;">
			              <?php if(!empty($days)) { foreach($days as $d) { ?>
			            	...
			            	<div class="row" style="margin-bottom: 10px;">
							  	...
							  	<label class="col-xs-1 control-label" <?php if($opening_hours[$d->id]['time_1'] == "CLOSED"){?>style="display:none;"<?php }else{ ?>style="padding-right: 0px; padding-left: 0px; width: 15px; margin-left: 5px;"<?php } ?>><?php echo _('to'); ?></label>
							  	<div class="col-xs-2" <?php if($opening_hours[$d->id]['time_1'] == "CLOSED"){?>style="display:none;"<?php }else{ ?>style="padding-right: 5px; "<?php } ?>>
							  	...
							  	<label class="col-xs-1 control-label" <?php if($opening_hours[$d->id]['time_1'] == "CLOSED"){?>style="display:none;"<?php }else{ ?>style="padding-right: 0px; padding-left: 0px; width: 25px; margin-left: 5px;"<?php } ?>><?php echo _('and'); ?></label>
							  	<div class="col-xs-2" <?php if($opening_hours[$d->id]['time_1'] == "CLOSED"){?>style="display:none;"<?php }else{ ?>style="padding-right: 5px; "<?php } ?>>
							  ...
							  <label class="col-xs-1 control-label" style="padding-left: 0px; padding-right: 0px; width: 15px; margin-left: 5px;"><?php echo _('to'); ?></label>
							  <div class="col-xs-2" style="padding-right: 5px;">
			            ...
			            <div class="form-group">
						    ...
						    <div class="col-xs-4">
						      	<select name="subject" id="subject" class="form-control input">
			              			<option value="abc" <?php if($suggestion['subject'] == 'abc'){?>selected="selected"<?php }?>><?php echo _('abc')?></option>
			              			<option value="xyz" <?php if($suggestion['subject'] == 'xyz'){?>selected="selected"<?php }?>><?php echo _('xyz')?></option>
				            	</select>
						    </div>
						</div>
		...
		<div id="TB_footer">
        	<a href="<?php echo base_url();?>rp/reseller/disapprove_suggestion/<?php echo $suggestion['id'];?>"><?php echo _("Disapprove");?></a>
        	<a href="<?php echo base_url();?>rp/reseller/block_ip/<?php echo $suggestion['id'];?>"><?php echo _("Block IP");?></a>
        	<a href="<?php echo base_url();?>rp/reseller/delete_company/<?php echo $suggestion['id'];?>"><?php echo _("Delete Company");?></a>
        </div>
	</body>
</html>