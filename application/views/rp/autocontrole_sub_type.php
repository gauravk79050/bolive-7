                            ...
                            <tbody>
                              <tr>
                                ...
                                <td width="40%" align="right">
                                  ...
                                  <div style="background-image:url(<?php echo base_url(); ?>assets/mcp/images/add.png);float:right;" title="<?php echo _('Add New Sub Type'); ?>" class="icon_button" onClick="window.location.href='<?php echo base_url();?>rp/autocontrole/sub_type_addedit'" id="btn_add">
                                  </div>
                                </td>
                              </tr>
                            </tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td width="20%"  valign="middle" bgcolor="#FFFFFF">
                                                          <span class="blackMediumNormal" style="padding:5px">
                                                            <img width="16" height="16" border="0" src="<?php echo base_url(); ?>assets/mcp/images/edit.jpg" alt="Edit" title="Edit" onclick="window.location.href='<?php echo base_url(); ?>rp/autocontrole/sub_type_addedit/<?php echo $sub_type[ 'id' ]; ?>'" style="cursor:pointer">
                                                          </span>
                                                        </td>
                                                      </tr>
                                                    <?php }
